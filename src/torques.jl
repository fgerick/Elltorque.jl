...
magpressuretorque(u,b,ω,b0,Ω,cmatbulk, coordinate) = int_polynomial_ellipsoid((∇(sum(b.*b0)) × [x,y,z])[coordinate],cmatbulk)
...
function torquebalance(N,a::T,b::T,c::T,us,ug,ua,bs,ω,b0,Ω; takeuni=false) where T
    ...
    for i = 1:3
        ...
        for j = 1:nm
            ...
            Γpmag[i][j] = magpressuretorque(u,bs[j],ω[j],b0,Ω,cmatbulk3var,i)
